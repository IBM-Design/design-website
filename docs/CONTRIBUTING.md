...
3. Once cloned, you will see `origin` as your default remote, pointing to your personal forked repository. Add a remote named `upstream` pointing to the main `design-website`:
   ...
   ```
   $ git remote add upstream git@github.com:ibm-design/design-website.git
   $ git remote -v
   ```
...
8. In GitHub, navigate to [ibm-design/design-website](https://github.com/ibm-design/design-website) and click the button that reads "Compare & pull request".
